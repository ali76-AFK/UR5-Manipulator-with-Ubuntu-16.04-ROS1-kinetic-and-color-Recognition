...
echo_and_run cd "/root/ur5_kinetic_ws/src/universal_robot/ur_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/root/ur5_kinetic_ws/src/universal_robot/ur_driver/setup.py" \
     \
    build --build-base "/root/ur5_kinetic_ws/build/universal_robot/ur_driver" \
    install \
    --root="${DESTDIR-/}" \
